...
class test_add_contacts(unittest.TestCase):
    ...
    def create_contact(self, wd):
        ...
        wd.find_element_by_name("middlename").send_keys("Anonim")
        ...
        wd.find_element_by_name("mobile").send_keys("+7888888888")
        wd.find_element_by_name("work").click()
        wd.find_element_by_name("work").clear()
        wd.find_element_by_name("work").send_keys("+7562562562")
        ...
        wd.find_element_by_name("email2").send_keys("email@mail2.ru")
